...
/* Add for operations on collection. */

/* APIs for Collection element. */
/* 555 */
EXTERN Tcl_CollectionElem **Tcl_NewCollectionElemArray _ANSI_ARGS_((int argc));
/* 556 */
EXTERN Tcl_CollectionElem *Tcl_NewCollectionElemWithItems _ANSI_ARGS_((char *objname,
                                              int objtype, void *objptr));
/* 557 */
EXTERN void Tcl_FreeCollectionElem _ANSI_ARGS_((Tcl_CollectionElem* objv));
/* 558 */
EXTERN void Tcl_FreeCollectionElemArray _ANSI_ARGS_((int argc,
                               Tcl_CollectionElem ** objv));

/* APIs for Collection. */
/* 559 */
EXTERN Tcl_Collection * Tcl_NewCollection _ANSI_ARGS_((const Tcl_Collection *objv));
/* 560 */
EXTERN Tcl_Collection * Tcl_NewEmptyCollection _ANSI_ARGS_((void));
/* 561 */
EXTERN Tcl_Collection * Tcl_NewCollectionFromArray _ANSI_ARGS_((int objc,
                               const Tcl_CollectionElem * const * objv,
                               int objtype));
/* 562 */
EXTERN Tcl_Collection * Tcl_NewCollectionWithArray _ANSI_ARGS_((int objc,
                               Tcl_CollectionElem ** objv,
                               int objtype));
/* 563 */
EXTERN void Tcl_FreeCollection _ANSI_ARGS_((Tcl_Collection *objv));
/* 564 */
EXTERN void Tcl_FreeCollectionContent _ANSI_ARGS_((Tcl_Collection *objv));
/* 565 */
EXTERN Tcl_Collection * Tcl_CollectionCopy _ANSI_ARGS_((const Tcl_Collection *src));
/* 566 */
EXTERN Tcl_Collection * Tcl_CollectionAppendElem _ANSI_ARGS_((Tcl_Collection *objv, 
                         Tcl_CollectionElem *elem));
/* 567 */
EXTERN Tcl_Collection * Tcl_CollectionAppend _ANSI_ARGS_((Tcl_Collection *src,
                               const Tcl_Collection *dst,
                               int unique));
/* 568 */
EXTERN Tcl_Collection * Tcl_CollectionMerge _ANSI_ARGS_((const Tcl_Collection *src,
                               const Tcl_Collection *dst,
                               int unique));
/* 569 */
EXTERN Tcl_Collection * Tcl_CollectionRemove _ANSI_ARGS_((Tcl_Collection *src,
                               const Tcl_Collection *dst));
/* 570 */
EXTERN Tcl_Collection * Tcl_CollectionSubtract _ANSI_ARGS_((const Tcl_Collection *src,
                               const Tcl_Collection *dst));
/* 571 */
EXTERN Tcl_Collection * Tcl_CollectionRemoveByPtr _ANSI_ARGS_((Tcl_Collection *src,
                               const void *objptr));
/* 572 */
EXTERN Tcl_Collection * Tcl_CollectionRemoveByName _ANSI_ARGS_((Tcl_Collection *src,
                               const char *objname,
                               int objtype));
/* 573 */
EXTERN int Tcl_CollectionCompare _ANSI_ARGS_((const Tcl_Collection *src,
                       const Tcl_Collection *dst,
                       int orderDep));
/* 574 */
EXTERN int Tcl_CollectionSize _ANSI_ARGS_((const Tcl_Collection *objv));
/* 575 */
EXTERN Tcl_CollectionElem * Tcl_CollectionIndex _ANSI_ARGS_((const Tcl_Collection *objv,
                                    int index));

/* APIs for Tcl Collection object. */
/* 576 */
EXTERN Tcl_Obj * Tcl_NewCollectionObjFromCollection _ANSI_ARGS_((const Tcl_Collection *objv));
/* 577 */
EXTERN Tcl_Obj * Tcl_NewCollectionObjWithCollection _ANSI_ARGS_((Tcl_Collection *objv));
/* 578 */
EXTERN Tcl_Obj * Tcl_NewCollectionObjFromArray _ANSI_ARGS_((int objc,
                               const Tcl_CollectionElem * const * objv,
                               int objtype));
/* 579 */
EXTERN Tcl_Obj * Tcl_NewCollectionObjWithArray _ANSI_ARGS_((int objc,
                               Tcl_CollectionElem ** objv,
                               int objtype));
/* 580 */
EXTERN Tcl_Obj * Tcl_CollectionObjCopy _ANSI_ARGS_((Tcl_Obj *src));
/* 581 */
EXTERN Tcl_Obj * Tcl_CollectionObjAppend _ANSI_ARGS_((Tcl_Obj *src, 
                         Tcl_Obj *dst, int unique));
/* 582 */
EXTERN Tcl_Obj * Tcl_CollectionObjMerge _ANSI_ARGS_((Tcl_Obj *src, 
                         Tcl_Obj *dst, int unique));
/* 583 */
EXTERN Tcl_Obj * Tcl_CollectionObjRemove _ANSI_ARGS_((
                    Tcl_Obj *src, Tcl_Obj *dst));
/* 584 */
EXTERN Tcl_Obj * Tcl_CollectionObjSubtract _ANSI_ARGS_((
                    Tcl_Obj *src, Tcl_Obj *dst));
/* 585 */
EXTERN int Tcl_CollectionObjCompare _ANSI_ARGS_((
                    Tcl_Obj *src, Tcl_Obj *dst, int orderDep));
/* 586 */
EXTERN int Tcl_CollectionObjSize _ANSI_ARGS_((
                    Tcl_Obj *objv, int *ssize));
/* 587 */
EXTERN int Tcl_CollectionObjIndex _ANSI_ARGS_((Tcl_Obj *objv,
                    int index, Tcl_Obj **result));

/* Miscellaneous APIs  */
/* 588 */
EXTERN Tcl_Obj * Tcl_GetCollectionObjByName _ANSI_ARGS_((const char *objname));
/* 589 */
EXTERN Tcl_Obj * Tcl_GetCollectionObjByObj _ANSI_ARGS_((Tcl_Obj *objv));
/* 590 */
EXTERN const Tcl_Collection * Tcl_GetCollection _ANSI_ARGS_((Tcl_Obj *objv));
/* 591 */
EXTERN Tcl_Collection * Tcl_Obj2Collection _ANSI_ARGS_((Tcl_Obj *objv));
/* 592 */
EXTERN void Tcl_InitTempColHashTable _ANSI_ARGS_((void));
/* 593 */
EXTERN char * Tcl_GenCollectionDescription _ANSI_ARGS_((const Tcl_Obj *objv));
