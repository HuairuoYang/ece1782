...
#pragma warning(disable: 4996)  //added by zuowei
#pragma warning(disable: 4133)  //added by zuowei
#pragma warning(disable: 4244)  //added by zuowei
...
/*
 * The flowing type is used for representing Tcl collection element.
 * This is a pointer to the element object.
 */

typedef struct Tcl_CollectionElem {
    char * elemName;         /* Name of element. */
    int elemType;            /* Type of element. */
    void * elemPtr;          /* Pointer to element object. */
} Tcl_CollectionElem;


/*
 * The structure used as the internal representation of Tcl collection
 * objects. This is an array of pointers to the element objects.
 */

typedef struct Tcl_Collection {
    int maxElemCount;           /* Total number of element array slots. */
    int elemCount;              /* Current number of collection elements. */
    int baseType;               /* Type of collection elements. */
                                /* If types of the elements are not all the same, baseType is 0. */
    int tmpIndex;               /* Temp index for collecion when stored in hash table. */
    Tcl_CollectionElem **elements;          /* Array of pointers to element objects. */
} Tcl_Collection;
...
#endif /* RC_INVOKED */
// Added by Yangzf @ 2013-08-27
EXTERN void Tcl_SetCmdLogFH(const char *logFile);
// Added by Ling Wang @ 13:31:48 2007-11-19
// ------------------------------------------------------------------------
EXTERN void tclIncrCmdLvl(Tcl_Interp *interp);
EXTERN void tclDecrCmdLvl(Tcl_Interp *interp);
// ------------------------------------------------------------------------
// Added by Ling Wang @ 16:00:02 2008-01-25
// ------------------------------------------------------------------------
EXTERN int tclInScript();
EXTERN char *tclCurrentSciptFileName();
EXTERN char *tclCurrentSciptBaseName();  
EXTERN int tclCurrentLineInScript(); 
// ------------------------------------------------------------------------
// Added by zuowei
EXTERN int icvTclNoSourchEcho;

EXTERN struct Tcl_Channel_* _cmdsLogChan;
EXTERN struct Tcl_ObjType tclProcBodyType;
// ------------------------------------------------------------------------
/*
 * end block for C++
 */
